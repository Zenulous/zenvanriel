...
class Background {
  ...
  Background() {
    for (int i=0; i<forest.length; i++) { 
      forest[i]= loadImage("/bluehat/background/forest_"+i+".png");
    }
  }
...
class Bluehat {
  ...
  Bluehat() {
    for (int i=0; i<bluehat.length; i++) {
      bluehat[i]= loadImage("/bluehat/bluehat/fly_"+i+".png");
    }
    for (int i=0; i<angel.length; i++) {
      angel[i]= loadImage("/bluehat/bluehat/angel_"+i+".png");
    }
    flydown=loadImage("/bluehat/bluehat/fly_down.png");
    flyup=loadImage("/bluehat/bluehat/fly_up.png");
    flyupleft=loadImage("/bluehat/bluehat/fly_upleft.png");
    flydownleft=loadImage("/bluehat/bluehat/fly_downleft.png");
  }
...
class Bluehatp2 {
  ...
  Bluehatp2() {
    for (int i=0; i<bluehatp2.length; i++) {
      bluehatp2[i]= loadImage("/bluehat/bluehat/flyp2_"+i+".png");
    }
    for (int i=0; i<angel.length; i++) {
      angel[i]= loadImage("/bluehat/bluehat/angel_"+i+".png");
    }
    flydown=loadImage("/bluehat/bluehat/flyp2_down.png"); 
    flyup=loadImage("/bluehat/bluehat/flyp2_up.png");
    flyupleft=loadImage("/bluehat/bluehat/flyp2_upleft.png");
    flydownleft=loadImage("/bluehat/bluehat/flyp2_downleft.png");
  }
...
class UI {
  ...
  UI() {
    ...
    clockg= loadImage("/bluehat/items/clockg_6.png");
    heart= loadImage("/bluehat/items/heart_0.png");
  }
...
class Shield {
  ...
  Shield() {
    for (int i=0; i<Shield.length; i++) { 
      Shield[i]= loadImage("/bluehat/items/shield_"+i+".png");
    }
  }
...
class Clockg {
  ...
  Clockg() {
    for (int i=0; i<clockg.length; i++) {
      clockg[i]= loadImage("/bluehat/items/clockg_"+i+".png");
    }
  }
...
class Coin {
  ...
  Coin() {
    for (int i=0; i<coin.length; i++) {
      coin[i]= loadImage("/bluehat/items/c"+i+".png");
    }
  }
...
class Fish {
  ...
  Fish() {
    for (int i=0; i<fish.length; i++) {
      fish[i]= loadImage("/bluehat/enemies/fish_"+i+".png");
    }
  }
...
class Magnet {
  ...
  Magnet() {
    magnet= loadImage("/bluehat/items/magnet_0.png");
  }
  void touchp1() {
    touchedp1=true;
    x=-100;
...
class Rose {
  ...
  int rosecount=0;
  Rose() {
    rose= loadImage("/bluehat/enemies/rose_0.png");
  }
...
class Saw {
  ...
  Saw() {
    for (int i=0; i<saw.length; i++) {
      saw[i]= loadImage("/bluehat/enemies/saw_"+i+".png");
    }
  }
...
class Spikedown {
  ...
  Spikedown() {
    for (int i=0; i<spikedown.length; i++) {
      spikedown[i]= loadImage("/bluehat/enemies/spikedown_"+i+".png");
    }
  }
...
class Spikeup {
  ...
  Spikeup() {
    for (int i=0; i<spikeup.length; i++) {
      spikeup[i]= loadImage("/bluehat/enemies/spikeup_"+i+".png");
    }
  }
...
class Poofeffect {
  ...
  for (int i=0; i<poof.length; i++) {
      poof[i]= loadImage("/bluehat/effects/poof_"+i+".png");
  }
  }
  void display() {
    if (poofswitchp1) {
...
class Titlescreen {
  ...
  int arrowposy=321;
  Titlescreen() {
    house=loadImage("/bluehat/titlescreen/house.png");
    arrow=loadImage("/bluehat/titlescreen/arrow.png");
    menu=loadImage("/bluehat/titlescreen/menu.png");
    title=loadImage("/bluehat/titlescreen/title.png");
    controls=loadImage("/bluehat/titlescreen/controls.png");
    for (int i=0; i<bluehat.length; i++) {
      bluehat[i]= loadImage("/bluehat/titlescreen/idle_"+i+".png");
    }
    for (int i=0; i<bluehatp2.length; i++) {
      bluehatp2[i]= loadImage("/bluehat/titlescreen/idlep2_"+i+".png");
    }
    for (int i=0; i<oldman.length; i++) {
      oldman[i]= loadImage("/bluehat/titlescreen/oldman_"+i+".png");
    }
    for (int i=0; i<cat.length; i++) {
      cat[i]= loadImage("/bluehat/titlescreen/cat_"+i+".png");
    }
    for (int i=0; i<forest.length; i++) {
      forest[i]= loadImage("/bluehat/titlescreen/forest_"+i+".png");
    }
  }
